...
■ 概要
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
マルミーニャＭは縦横12ピクセルサイズのピクセルフォントです。
ひらがな・カタカナが「まるもじ」になっていて、かわいい用途に抜群の相性を発揮します！

丸ゴシック体である「マルミーニャ」のマイナーチェンジ版であり、ひらがな・カタカナ・全角数字などの形状を変更したバージョンになります。
仕様上互換性がとても高いので、お好みに応じて使い分けてみて下さい。

本テキストには利用規約やフォントの仕様、また便利な各グリフの一覧などを収めましたのでご活用下さい。
表示フォントをx12y12pxMaruMinyaM、文字サイズを96dpiの場合9pt、72dpiの場合12ptとすると、対応した表示環境であればピクセルの滲みのないビットマップ表示で字形を確認することができます。


【x12y12pxMaruMinyaM_Readme.txt】
本テキストです。利用規約に同意の上、遵守してフォントをご利用下さい。

【x12y12pxMaruMinyaM.ttf】
...
（SNSでのいいねやリプライ、マシュマロひとつでも日々の制作の大きな励みになっています。いつもありがとうございます）
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
※このReadmeテキストの表示フォントをマルミーニャＭにすることで表示されます。
...
■ おわりとはじまりに
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
「マルミーニャＭ」をダウンロードしていただき、ありがとうございます！

まるもじピクセルフォントの新たなスタンダードを目指した、マルミーニャのかわいさ特化バージョンです。
カワイイドット絵やゲーム感のあるコンテンツに、ぜひ活用してくださいね！

支援版やBOOSTの上乗せも、本当にありがとうございます。これからも良いピクセルフォントを提供していくために、ぜひご協力ください！
